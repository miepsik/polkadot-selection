...
<?php $hero_desc = 'In this stage, we use an active learning algorithm that learns from your answers and provides a recommendation of suited validators for you.'; ?>
    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col col-lg-6">
                ...
                <p>In the following, we present you a choice between two validators and ask you to select which of the two you prefer. We ask you to answer five of those pairwise comparisons. Afterwards, the algorithm selects the most suited validators from all available validators.</p>
            </div>
            <div class="col-12">
